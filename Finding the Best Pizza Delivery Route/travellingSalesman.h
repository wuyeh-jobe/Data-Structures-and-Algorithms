...
void backtrack(int a[], int k, int input, int distances[NUMBER_OF_STOPS][NUMBER_OF_STOPS]);  // original backtrack 
bool is_a_solution(int a[], int k, int n);                                            // 
void construct_candidates(int a[], int k, int n, int c[], int *ncandidates);          // permutation construct_candidates
void process_solution(int a[], int k, int input, int distances[NUMBER_OF_STOPS][NUMBER_OF_STOPS]);                                         // original process_solution 
