/* 
   ...
   ****************************************************************************************************************
   ...
   Wuyeh Jobe
   Added functions to find path with minimum distance and printing route details to file
   29 April 2020
*/
...
int main() {
   ...
   for (k=0; k<number_of_test_cases; k++) {
     ...
     backtrack(a,0,n, distances);    // this is the original call and will just print the permutations to the terminal
