/* 
  ...
  Wuyeh Jobe
  29 March 2020
  Adapted find path to mark the path vertices to the map
...
bool find_path_and_trace(graph *g, int start, int goal, int *map[], int map_dimension_x, int map_dimension_y);
